To define this feature effectively for a development team or an AI coding assistant, the prompt needs to bridge the gap between user experience and technical implementation.

Below is a structured **Feature Definition Prompt** you can use. It is formatted to be pasted directly into a project management tool (like Jira or GitHub Issues) or a generative AI to kickstart development.
...
**As an** M&E Officer,
**I want to** select a specific data field (e.g., Gender, Region, or Project Status),
